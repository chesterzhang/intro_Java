...
public class ArrayDemo2 {
    public static void main(String[] args) {
        ...
        float[][]  floatArray = new float[3][]; // 必须要指定行数,列数可以省略
        ...
        System.out.println("num数组第1行第2列的元素为:" + num1[0][1]);
        System.out.println("num数组的行数为:" + num1.length);
        System.out.println("num数组的列数为:" + num1[0].length);

        //二维数组初始化，每一行列数不相等
        int[][] num2 = { { 78, 98 }, { 65, 75, 63, 63 }, { 98 } };
        System.out.println("num1数组第1行的列数为:" + num2[0].length);
